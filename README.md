...
├── src/ # Scripts for preprocessing, modeling, and utilities
├── README.md
...
Open notebooks/churn_prediction.ipynb in Google Colab or Jupyter

Execute all cells to reproduce results and visualizations

Results & Impact
Random Forest achieved ~85% accuracy, with strong Precision and Recall scores.

Key features influencing churn were identified, enabling targeted customer retention strategies.

Demonstrates practical application of ML to real-world business problems.
